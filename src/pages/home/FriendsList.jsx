  ...
  return (
    <div className="p-4 bg-gray-900 space-y-4">
      ...
      {friends.length === 0 ? (
        ...
        friends.map((friend) => (
          <div key={friend.id} className="flex items-center space-x-4 p-2 bg-gray-800 rounded-lg">
            <img src={friend.profile_pic} alt={friend.name} className="w-10 h-10 rounded-full" />
